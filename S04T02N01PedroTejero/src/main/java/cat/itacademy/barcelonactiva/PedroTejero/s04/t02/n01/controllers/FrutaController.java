...
public class FrutaController {
	...
	@Autowired // inyección de la dependencia para poder usar los métodos existentes en JPA
				// repository
	...
	public ResponseEntity<Fruta> createFruta(@RequestBody Fruta fruta) {
		try {
			...
			// Fruta fruta2= new Fruta(fruta.getId(), fruta.getname(),
			// fruta.getCantidadKilos());
